# CineRoom - Приложение позволяющее составлять коллекцию любимых фильмов, выставлять оценки, сохранять на телефон понравившиеся кадры и постеры. Так же имеется возможность мгновенно перейти к просмотру трейлера фильма на YouTube, а так же к поиску фильма в Вк Видео (Для корректной работы приложения необходим VPN)
